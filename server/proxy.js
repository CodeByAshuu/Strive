...
// workoutSplit endpoint
app.post('/api/generate-workout-split', async (req, res) => {
  try {
    ...
    console.log('📤 Generating workout split...');
    ...
    console.log('✅ Received workout split response from Gemini API');
    ...
    try {
      ...
      if (parsedContent.days && Array.isArray(parsedContent.days)) {
        console.log('🎉 Successfully generated workout split!');
